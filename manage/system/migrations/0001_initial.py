    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_language', models.IntegerField(verbose_name='Язык докуменат')),
                ('document', models.FileField(blank=True, null=True, upload_to='docs/%Y/%m/%D/', verbose_name='Документ')),
            ],
            options={
